...
public class LieuxService
{
    ...
    protected void Init()
    {
        ...
        lieuDeLivraisonDetail = Enumerable.Range(0, 5).Select(index => new LieuDeLivraisonDetailDto(index+1, names[index], num[index], rues[index], "64260", "Arudy")).ToList();
    ...
    public void AddLocation(LieuxDeLivraisonModel lieu)
    {
        ...
        lieuDeLivraisonDetail.Add(new LieuDeLivraisonDetailDto(DateTime.Now.Minute + DateTime.Now.Second, lieu.Nom, lieu.Numero, lieu.Rue, lieu.CodePostal, lieu.Ville));
    }
    ...
    public void UpdateLocation(LieuxDeLivraisonModel lieu)
    {
        ...
        if (index != -1)
        {
            ...
            lieuDeLivraisonDetail[index] = new LieuDeLivraisonDetailDto(lieu.Id.GetValueOrDefault(), lieu.Nom, lieu.Numero, lieu.Rue, lieu.CodePostal, lieu.Ville);
        }
    }
